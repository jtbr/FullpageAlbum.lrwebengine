...
callCallback = function() {
	/* if (typeof myCallback == 'undefined') return; // DO NOT DO THIS CHECK, even under LR it fails, but the call works */
...
//------------------------------------------------------------
/* Called by liveUpdate to change page CSS */
document.liveUpdateProperty = function( id, property, value ) {
//AgDebugPrint( "document.liveUpdateProperty( " + id + ", " + property + ", " + value + " ) " );
...
//------------------------------------------------------------
// TODO: do a better job of allowing minimal updates to occur on property changes
document.liveUpdate = function( path, newValue, cssId, property ) {
//AgDebugPrint( "document.liveUpdate( " + path + ", " + newValue + ", " + cssId + " , " + property + " ) " );
	return "invalidateOldHTML"; // regenerate and reload index.html.
	
	/* unused (CSS is embedded in html, not in custom.css): */
	var success = "failed";
	var reg = /(^[^.]+)\./;
